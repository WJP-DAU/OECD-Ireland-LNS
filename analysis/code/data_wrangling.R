...
wrangle_ireland_lns <- function(master_data) {
  ...
  data_subset.df <- master_data %>%
    mutate(
      ...
      needed_assistance_prof = case_when(
        ...
        &
          (AJD_noadvice_reason_7 == 1 | AJD_noadvice_reason_8 == 1 | AJD_noadvice_reason_9 == 1 |
             ...
             AJD_noadvice_reason_16 == 1 | AJD_noadvice_reason_17 == 1) 
        &
      ...
      reason_legalcap = case_when(
        (AJD_noadvice_reason_10 == 1 | 
           AJD_noadvice_reason_13==1 | 
           AJD_noadvice_reason_14 == 1 | 
    ...
    reason_interpersonal = case_when(
    ...
    reason_prev = case_when(
      AJD_noadvice_reason_15 == 1 
      &
        (AJD_noadvice_reason_1 == 0 & AJD_noadvice_reason_2 == 0 & AJD_noadvice_reason_3 == 0 &
           AJD_noadvice_reason_4==0 & AJD_noadvice_reason_5 == 0 & AJD_noadvice_reason_6 == 0) ~ 1,
    ...
    reason_external = case_when(
     (AJD_noadvice_reason_7 ==1 |
      AJD_noadvice_reason_8 ==1 |
      AJD_noadvice_reason_9 ==1 |
      AJD_noadvice_reason_11 ==1 |
      AJD_noadvice_reason_12 ==1 |
      AJD_noadvice_reason_15 ==1 |
      AJD_noadvice_reason_17 ==1)
     &
       (AJD_noadvice_reason_1 == 0 & AJD_noadvice_reason_2 == 0 & AJD_noadvice_reason_3 == 0 &
     ...
     (AJD_adviser_1 == 2 & AJD_adviser_2 == 2 & AJD_adviser_3 == 2 & AJD_adviser_4 == 2 &
      ...
      legalcap_drm = case_when(
        had_dispute == 0 ~ NA_real_,
        (AJR_noresol_reason_7 == 1 | AJR_noresol_reason_13 == 1 | AJR_noresol_reason_15 == 1) 
        &
      ...
      legal_assis_drm = case_when(
        had_dispute == 0 ~ NA_real_,
        AJR_noresol_reason_8 == 1 
        &
        (AJR_noresol_reason_1 == 0 & AJR_noresol_reason_2 == 0 & AJR_noresol_reason_3 == 0 &
         AJR_noresol_reason_4 == 0 & AJR_noresol_reason_5 == 0 & AJR_noresol_reason_6 == 0) ~ 1,
       ...
       process_drm = case_when(
         had_dispute == 0 ~ NA_real_,
         (AJR_noresol_reason_9 == 1 | AJR_noresol_reason_10 == 1 | AJR_noresol_reason_11 == 1)
         &
         (AJR_noresol_reason_1 == 0 & AJR_noresol_reason_2 == 0 & AJR_noresol_reason_3 == 0 &
          AJR_noresol_reason_4 == 0 & AJR_noresol_reason_5 == 0 & AJR_noresol_reason_6 == 0) ~ 1,
        ...
        interpersonal_drm = case_when(
          had_dispute == 0 ~ NA_real_,
          AJR_noresol_reason_14 == 1 
          &
            (AJR_noresol_reason_1 == 0 & AJR_noresol_reason_2 == 0 & AJR_noresol_reason_3 == 0 &
               AJR_noresol_reason_4 == 0 & AJR_noresol_reason_5 == 0 & AJR_noresol_reason_6 == 0) ~ 1,
        ...
        external_bar_drm = case_when(
          had_dispute == 0 ~ NA_real_,
         (AJR_noresol_reason_8 == 1 | 
          AJR_noresol_reason_9 == 1 | 
          AJR_noresol_reason_10 == 1 | 
          AJR_noresol_reason_11 == 1 | 
          AJR_noresol_reason_12 == 1 | 
          AJR_noresol_reason_14 == 1 | 
          AJR_noresol_reason_16 == 1)
         &
