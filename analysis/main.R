...
plot_panel_indicators(
  tables = tables,
  indicator_ids = c(
    "reason_no_need", "reason_legalcap", "reason_process",
  ...
  params = params,
  group_filters = c(
    "Overall", "gender", "age_group", "edu_level",
...
plot_panel_indicators(
  tables = tables,
  indicator_ids = c(
    "no_need_action", "legalcap_action", "process_action", "interpersonal_action",
    "bigger_action", "other_action"
  ),
  indicator_labels = c(
    no_need_action = "No need/\nwas not needed",
  ...
  params = params,
  group_filters = c(
    "Overall", "gender", "age_group", "edu_level", "income",
...
plot_panel_indicators(
  tables = tables,
  indicator_ids = c(
    "no_need_drm", "legalcap_drm", "process_drm", "legal_assis_drm", "trust_drm",
...
plot_panel_indicators(
  ...
  indicator_labels = c(
    impact_1 = "None at all", impact_2 = "Slight", impact_3 = "Moderate",
...
plot_panel_indicators(
  ...
  indicator_labels = c(
    hardship_5_bin_p = "Damage to property",
